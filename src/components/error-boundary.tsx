...
export function RouteErrorFallback() {
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-2xl flex-col items-center justify-center px-4 text-center">
      ...
      <h1 className="text-2xl font-bold text-gray-900">Pagina non disponibile</h1>
      <p className="mt-3 text-gray-600">
        Si è verificato un errore durante il caricamento di questa pagina. Il nostro team è stato notificato.
      </p>
      <a
        href="/"
